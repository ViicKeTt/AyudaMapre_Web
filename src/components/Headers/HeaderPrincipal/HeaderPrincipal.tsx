...
const HeaderPrincipal = () => {
  useEffect(() => {
    const SecureMessageNav = document.getElementById('SecureMessageNav')
    const MessageNav = document.createElement("official-header")
    SecureMessageNav?.append(MessageNav)
    
    return () => {
      if (SecureMessageNav) {
        SecureMessageNav.innerHTML = ''
      }
    }
  }, [])
